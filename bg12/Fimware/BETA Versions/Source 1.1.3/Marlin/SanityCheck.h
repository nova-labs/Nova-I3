 ...
 */
  ...
  #error "PETG_PREHEAT_HOTEND_TEMP is now PREHEAT_2_TEMP_HOTEND. Please update your configuration."
#elif defined(PETG_PREHEAT_HPB_TEMP)
  #error "PETG_PREHEAT_HPB_TEMP is now PREHEAT_2_TEMP_BED. Please update your configuration."
#elif defined(PETG_PREHEAT_FAN_SPEED)
  #error "PETG_PREHEAT_FAN_SPEED is now PREHEAT_2_FAN_SPEED. Please update your configuration."
