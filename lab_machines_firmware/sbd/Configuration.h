...
#define STRING_CONFIG_H_AUTHOR "(paenian, sbd config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Silent but Daedalus"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2000, 155 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 12, -1 }
